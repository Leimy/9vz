                      ...
                      enableController:(BOOL)enableController
{
    ...
    if (@available(macOS 14.0, *)) {
        ...
        // 9vz: keep OFF so our configured scanout sticks and is
        // upscaled (YES resizes the guest display to native Retina
        // density, overriding the scanout and defeating -scale).
